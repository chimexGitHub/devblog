...
<div class="content-wrapper">
   ...
   <?php echo $__env->make('includes.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <div class="container">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="15_blog_details.html"><?php echo e($first_post->title); ?></a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                                <?php echo e($first_post->created_at->diffForHumans()); ?>
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="#"><?php echo e($first_post->category->name); ?></a>
                                        </span>
        ...
        <div class="row">
            <div class="col-lg-6">
                <article class="<?php echo e($second_post->title); ?>">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="#"><?php echo e($second_post->category->name); ?></a>
                                        </span>
            ...
            <div class="col-lg-6">
                <article class="<?php echo e($third_post->title); ?>">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="15_blog_details.html"><?php echo e($third_post->title); ?></a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="#"><?php echo e($third_post->category->name); ?></a>
                                        </span>
